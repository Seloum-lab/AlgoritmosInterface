 ...
 * @author DeLL
 */
public class GetNextsAppointmentsAction extends Action{
    ...
    public void execute(HttpServletRequest req) {
        ...
        try {
            listAppointmentClient = Service.getNextsAppointmentAsClient(id);
            listAppointmentWorker = Service.getNextsAppointmentAsWorker(id);
